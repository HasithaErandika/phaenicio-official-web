...
const Home = () => {
  return (
    <div className="flex flex-col pt-[140px] pb-10 animate-in fade-in duration-700">
      ...
      <section className="relative pt-16 pb-28 px-6 md:px-12 overflow-hidden border-b border-slate-200/60 bg-transparent">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center flex flex-col items-center">
          ...
          <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight leading-[1.05] mb-6 text-slate-950 text-balance">
            Engineering the <br />
          ...
          <p className="text-lg md:text-xl text-slate-600 leading-relaxed mb-10 max-w-2xl text-balance">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center w-full sm:w-auto">
            <a 
              href="#products" 
              className="px-8 py-4 bg-slate-950 text-white rounded-full font-semibold transition-all duration-300 hover:bg-slate-800 shadow-[0_8px_20px_rgba(15,23,42,0.15)] hover:shadow-[0_12px_24px_rgba(15,23,42,0.2)] flex items-center justify-center gap-2 group text-sm hover:scale-105 active:scale-95"
            >
            ...
            <Link 
              to="/about" 
              className="px-8 py-4 bg-white/50 backdrop-blur-sm border border-slate-200 hover:border-slate-300 text-slate-800 rounded-full font-semibold transition-all duration-300 shadow-sm hover:bg-white flex items-center justify-center gap-2 text-sm hover:scale-105 active:scale-95"
            >
      ...
      <section id="products" className="py-24 px-6 md:px-12 bg-transparent relative overflow-hidden">
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <div className="text-center max-w-3xl mx-auto mb-20">
            <span className="text-xs uppercase font-mono tracking-widest text-indigo-600 font-bold block mb-4">Product Ecosystem</span>
            <h2 className="text-4xl font-extrabold tracking-tight mb-6 text-slate-950">
              The Phaenicio Suite
            </h2>
          ...
          <div className="grid grid-cols-1 gap-8">
            ...
            <div className="relative p-[1px] rounded-[2rem] bg-gradient-to-br from-slate-200 to-transparent overflow-hidden group hover:shadow-2xl hover:shadow-indigo-500/5 transition-all duration-500">
              ...
              <div className="relative z-10 p-10 md:p-14 flex flex-col md:flex-row gap-10 justify-between items-start md:items-center bg-white/50 backdrop-blur-2xl rounded-[calc(2rem-1px)]">
                <div className="flex-grow max-w-3xl">
                  <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-indigo-50 text-indigo-600 border border-indigo-100 text-xs font-bold uppercase tracking-wider mb-6 shadow-sm">
                    <span className="w-1.5 h-1.5 bg-indigo-600 rounded-full animate-pulse-dot"></span>
                    Flagship Product
                  </span>
                  <h3 className="text-3xl font-extrabold mb-4 text-slate-950">Zosterix</h3>
                ...
                <div className="shrink-0 w-full md:w-auto mt-4 md:mt-0">
                  <a 
                    ...
                    className="inline-block w-full px-8 py-4 bg-slate-950 text-white rounded-full font-semibold hover:bg-slate-800 transition-all text-center text-sm shadow-[0_8px_16px_rgba(0,0,0,0.1)] hover:shadow-[0_12px_24px_rgba(0,0,0,0.15)] hover:-translate-y-0.5 active:translate-y-0"
                  >
      ...
      <section className="py-24 px-6 md:px-12 bg-slate-100/50 relative border-y border-slate-200/50">
        <div className="absolute top-1/2 left-1/4 -translate-y-1/2 w-96 h-96 bg-indigo-400/5 rounded-full blur-3xl pointer-events-none"></div>
        <div className="max-w-4xl mx-auto relative z-10 text-center md:text-left">
          <span className="text-xs uppercase font-mono tracking-widest text-indigo-600 font-bold block mb-6">Our Vision</span>
      ...
      {/* Final CTA Section */}
      <section className="my-24 mx-6 md:mx-12 text-center relative overflow-hidden rounded-[2.5rem] bg-slate-950">
        <div className="absolute inset-0 bg-gradient-to-b from-indigo-900/20 to-transparent"></div>
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-indigo-500/20 blur-[100px] rounded-full pointer-events-none"></div>
        
        <div className="relative z-10 max-w-2xl mx-auto py-24 px-8">
          <h2 className="text-4xl font-extrabold tracking-tight mb-5 text-white">Join the Future of Discovery</h2>
          ...
          <Link 
            to="/contact" 
            className="inline-flex items-center gap-2 px-8 py-4 bg-white text-slate-950 rounded-full font-bold text-sm transition-all duration-300 hover:bg-slate-100 shadow-[0_0_24px_rgba(255,255,255,0.1)] hover:shadow-[0_0_32px_rgba(255,255,255,0.2)] hover:scale-105 active:scale-95"
          >
